...
public class VectorialPointValuePair implements Serializable {
    ...
    public VectorialPointValuePair(final double[] point, final double[] value) {
        this.point = (point == null) ? null : Utils.clone(point);
        this.value = (value == null) ? null : Utils.clone(value);
    }
    ...
    public VectorialPointValuePair(final double[] point, final double[] value,
        ...
        this.point = copyArray ?
                      ((point == null) ? null : Utils.clone(point)) :
                      point;
        this.value = copyArray ?
                      ((value == null) ? null : Utils.clone(value)) :
                      value;
    }
    ...
    public double[] getPoint() {
        return (point == null) ? null : Utils.clone(point);
    }
    ...
    public double[] getValue() {
        return (value == null) ? null : Utils.clone(value);
    }
