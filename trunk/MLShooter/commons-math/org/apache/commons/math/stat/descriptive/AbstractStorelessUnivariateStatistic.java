...
public abstract class AbstractStorelessUnivariateStatistic
    ...
    public boolean equals(Object object) {
       ...
       if (object instanceof AbstractStorelessUnivariateStatistic == false) {
        ...
        return equalsIncludingNaN(stat.getResult(), this.getResult()) &&
               equalsIncludingNaN(stat.getN(), this.getN());
    }
    ...
    @Override
    public int hashCode() {
        return 31* (31 + new Double(getResult()).hashCode()) + new Long(getN()).hashCode();
    }
